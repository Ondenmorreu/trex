...
function draw() {
  ...
  text("Pontuação: "+ score, width -100,height/2);
...
function spawnClouds() {
  ...
  if (frameCount % 60 === 0) {
    ...
    var cloud = createSprite(width -100,height -200,40,10);
...
function spawnObstacles() {
  if(frameCount % 60 === 0) {
    ...
    var obstacle = createSprite(width /2,height -35,10,40);
    //obstacle.debug = true;
